...
function autocomplete(input, latInput, lngInput) {
  if (!input) return; //skip this if no input
...
function makeMap(mapDiv) {
  ...
  //Listen in case a new place is requested
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    //hide search results and return if nothing in search bar
    if (!this.value) {
      searchResults.style.display = 'none';
      return;
    }
    //If there is something show the bitches what they wanna see
