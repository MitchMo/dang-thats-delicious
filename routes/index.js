...
router.post('/register',
  userController.validateRegister,//1. Validate the registration data: userController.validateRegister
  userController.register,        //2. Register the user: userController.register
  authController.login);          //3. Log user in: authController.login
router.get('/logout',
